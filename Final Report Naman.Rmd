...
The outcome variable is a binary indicator of death within 5 years (inddea). Predictors include:
 ...
 - Socioeconomic: income-to-poverty ratio (povpct), education, employment, occupation, citizenship
 - Household/Social: marital status, living arrangement, veteran status
 - Health-related: health insurance coverage, smoking status (smokstat), smokeless tobacco use
