...
caption="TABLE 3: Five-fold cross-validation results for LightGBM.")
```
...
caption="TABLE 4: Held-out test-set performance for LightGBM.")
```
...
# References
Dhariwal, N., Sengupta, N., Madiajagan, M., Patro, K. K., Kumari, P. L., Abdel Samee, N., Tadeusiewicz, R., Pławiak, P., & Prakash, A. J. (2024). A pilot study on AI-driven approaches for classification of mental health disorders. Frontiers in Human Neuroscience, 18, Article 1376338. <https://doi.org/10.3389/fnhum.2024.1376338>
